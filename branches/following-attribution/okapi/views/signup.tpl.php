			...
			<div class='okd_top'>
				...
				<table cellspacing='0' cellpadding='0'><tr>
					...
					<td class='article'>
						...
						geocache descriptions or providing it in a separate data field. Refer to
						<a href="<?= $vars['site_url'].'okapi/services/caches/geocache.html#opt_attribution' ?>">services/cache/geocache</a>
						documentation for further advice.
						<? } else { ?>
						attribute the data back to <?= $vars['site_name'] ?>.</p>
						<ul>
