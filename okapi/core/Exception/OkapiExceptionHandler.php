...
class OkapiExceptionHandler
{
    ...
    public static function handle($e)
    {
        if ($e instanceof OAuthServerException) {
            ...
            echo "Oops... Something went wrong on *our* part.\n\n";
            echo "Message was passed on to the site administrators. We'll try to fix it.\n";
            echo 'Contact the developers if you think you can help!';
            ...
            if (class_exists(Settings::class) && (Settings::get('DEBUG'))) {
                ...
                echo "Let's cut to the chase then:";
                echo "\n\n".$exception_info;
            }
