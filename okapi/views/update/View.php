...
class View
{
    ...
    private static function ver1()
    {
        ob_start();
        echo "Hi!\n\n";
        echo "Since this is your first time you run okapi/update, you should be\n";
        echo "prepared to receive a bunch of update-history emails. These are all\n";
        echo "the emails that all the other OC admins received \"over the years\",\n";
        echo "whenever they have updated OKAPI.\n\n";
        echo "Each email describes an action which OKAPI performed on your\n";
        echo "database, OR which we need YOU to perform.\n\n";
        echo "If you receive any error messages during the update process,\n";
        echo "please contact me - rygielski@mimuw.edu.pl.\n\n";
        echo "-- \n";
        echo 'Wojciech Rygielski, OKAPI developer';
    ...
    private static function ver43()
    {
        ...
        ob_start();
        echo "Hi!\n\n";
        echo "We send this email to all developers who used 'replicate' module\n";
        echo "in last 14 days. Thank you for testing our BETA-status module.\n\n";
        echo "As you probably know, BETA status implies that we may decide to\n";
        echo "modify something in a backward-incompatible way. One of such\n";
        echo "modifications just happened and it may concern you.\n\n";
        echo "We removed 'attrnames' from the list of synchronized fields of\n";
        echo "'geocache'-type objects. Watch our blog for updates!\n\n";
        echo "-- \n";
        echo 'OKAPI Team';
    ...
    private static function ver48()
    {
        ob_start();
        echo "Hi!\n\n";
        echo "OKAPI just added additional field (along with an index) 'okapi_syncbase'\n";
        echo "on your 'caches' table. It is required by OKAPI's 'replicate' module to\n";
    ...
    {
        echo "-- About OKAPI's database modifications --\n\n";
        echo "OKAPI takes care of its own tables (the ones with the \"okapi_\"\n";
        echo "prefix), but it won't usually alter other tables in your\n";
        echo "database. Still, sometimes we may change something\n";
        echo "slightly (either to make OKAPI work properly OR as a part of\n";
        echo "bigger \"international Opencaching unification\" ideas).\n\n";
        echo "We will let you know every time OKAPI alters database structure\n";
        echo "(outside of the \"okapi_\" table-scope). If you have any comments\n";
        echo "on this procedure, please submit them to our issue tracker.\n\n";
    }
    ...
    private static function ver57()
    {
        ...
        echo "Hi!\n\n";
        echo "OKAPI just added additional field (along with an index) 'okapi_syncbase'\n";
        echo "on your 'cache_logs' AND 'cache_logs_archived' tables. It is required by\n";
        echo "OKAPI's 'replicate' module to function properly.\n\n";
        self::print_common_db_alteration_info();
        echo "-- \n";
        echo 'OKAPI Team';
        Okapi::mail_admins('Database modification notice: caches.okapi_syncbase', ob_get_clean());
